...
Таким образом, pg_prewarm с помощью всего одной функции дает возможность управлять прогревом данных в PostgreSQL, но отсутствует статистический отбор данных по частоте обращений.
